...
qtcreator_file  = "ui/krsAdmin.ui"
Ui_MainWindow, QtBaseClass = uic.loadUiType(qtcreator_file)


class KrsAdminWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.btnCariProdi.clicked.connect(self.searchProdi)
    ...
    def searchData(self):
        try:
            ...
            # search process
            result = krs.getKrsByKodeTransaksi(kode_transaksi)
            a = krs.affected
            if(a>0):
